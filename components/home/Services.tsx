              ...
              <div className="mt-4 flex justify-end">
                ...
                {isModalOpen && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                    <div className="relative w-full max-w-md md:max-w-lg bg-white dark:bg-secondary-900 rounded-lg shadow-lg">
                      <button
                        type="button"
                      ...
                      <div className="px-6 py-6 lg:px-8">
                        <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                          Contact Us for {modalIndustry}
                        </h3>
                        <ContactUs defaultIndustry={modalIndustry} onClose={handleCloseModal} isModal={true} />
                      </div>
                    </div>
                  </div>
                )}
