...
const SaviBot: React.FC<SaviBotProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-secondary-900 rounded-xl shadow-2xl w-full max-w-md h-[600px] max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-4 border-t border-gray-100 dark:border-secondary-800">
          ...
          <div className="mt-3 flex space-x-2">
            <button className="bg-gray-100 dark:bg-secondary-800 hover:bg-gray-200 dark:hover:bg-secondary-700 text-xs px-3 py-1 rounded-full text-gray-700 dark:text-gray-300">
              AI solutions
            </button>
            <button className="bg-gray-100 dark:bg-secondary-800 hover:bg-gray-200 dark:hover:bg-secondary-700 text-xs px-3 py-1 rounded-full text-gray-700 dark:text-gray-300">
              Video animation
